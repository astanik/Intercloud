...
public class AgreementKind extends Kind {

	public final static String AgreementTitle = "Agreement Resource";
	
	public final static String AgreementSchema = "http://schema.cit.tu-berlin.de/occi/sla#";
	
	public final static String AgreementTerm = "agreement";
	
	public AgreementKind() {
		super(AgreementSchema, AgreementTerm, AgreementTitle);
	}
	...
	protected void defineAttributes(Category category) {
		...
		// define base name
		String baseName = "occi.agreement.";

...
public class XwadlFileBuilder {
    ...
    public String createXwadlFile(XwadlFileConfig config) throws IOException {
        ...
        GrammarsDocument.Grammars grammars = xwadl.addNewGrammars();
        ClassificationDocument classification = createClassification(config);
        grammars.set(classification);
        // METHOD: POST
        MethodDocument.Method method = xwadl.addNewMethod();
    ...
    private String createXwadlFile(XwadlDocument xwadlDocument, XwadlFileConfig config) throws IOException {
        ...
        xwadlDocument.getXwadl().setPath(file.getAbsolutePath());
        PrintWriter printWriter = new PrintWriter(file);
        try {
            printWriter.print(xwadlDocument.toString());
        } finally {
            printWriter.close();
        }
        return file.getPath();

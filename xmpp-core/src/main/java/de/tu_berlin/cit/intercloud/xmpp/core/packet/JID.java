...
package de.tu_berlin.cit.intercloud.xmpp.core.packet;
...
import de.tu_berlin.cit.intercloud.xmpp.core.util.ValueWrapper;
import de.tu_berlin.cit.intercloud.xmpp.core.util.ValueWrapper.Representation;
...
public class JID implements Comparable<JID>, Serializable {
    ...
    private static final ConcurrentMap<String, ValueWrapper<String>> NODEPREP_CACHE = new ConcurrentHashMap<String, ValueWrapper<String>>(10000);
    private static final ConcurrentMap<String, ValueWrapper<String>> DOMAINPREP_CACHE = new ConcurrentHashMap<String, ValueWrapper<String>>(500);
    private static final ConcurrentMap<String, ValueWrapper<String>> RESOURCEPREP_CACHE = new ConcurrentHashMap<String, ValueWrapper<String>>(10000);

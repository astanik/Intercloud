...
public class ResourceTest {
	...
	private static final String uriPrefix = "xmpp://" + testURI + "#";
	...
	private void testXWADL(ResourceInstance instance) {
		List<ResourceInstance> resources = instance.getResources();
